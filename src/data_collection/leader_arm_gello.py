...
class LeaderArmGello:
    ...
    def get_cmd_to_flexiv(self):
        ...
        end_effector_pos, end_effector_ori, leader_gripper_pos = self.feedforward_kinetic()
        ...
        cmd_end_effector_pos = end_effector_pos
        cmd_end_effector_pos[0] *=3
        cmd_end_effector_pos[1] *=3
        cmd_end_effector_pos[2] = (cmd_end_effector_pos[2] - 0.16)*3
        ...
        return cmd_end_effector_pos, cmd_quat_numpy, rot_matrix, cmd_gripper_pos*2
